...
#ifndef SPACESALVAGERS_SWIFT_H
#define SPACESALVAGERS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SpaceSalvagers",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14SpaceSalvagers11AppDelegate")
...
@class UIEvent;
@class NSCoder;
SWIFT_CLASS("_TtC14SpaceSalvagers9GameScene")
...
@class NSString;
@class NSBundle;
SWIFT_CLASS("_TtC14SpaceSalvagers18GameViewController")
...
SWIFT_CLASS("_TtC14SpaceSalvagers9HealthBar")
...
SWIFT_CLASS("_TtC14SpaceSalvagers13MainMenuScene")
...
SWIFT_CLASS("_TtC14SpaceSalvagers17MapSelectionScene")
@interface MapSelectionScene : SKScene
- (void)didMoveToView:(SKView * _Nonnull)view;
- (void)touchesBegan:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)touchesMoved:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)touchesEnded:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
...
@class UIWindow;
@class UIScene;
SWIFT_CLASS("_TtC14SpaceSalvagers13SceneDelegate")
...
SWIFT_CLASS("_TtC14SpaceSalvagers13SettingsScene")
...
SWIFT_CLASS("_TtC14SpaceSalvagers11StationCore")
@interface StationCore : SKNode
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
