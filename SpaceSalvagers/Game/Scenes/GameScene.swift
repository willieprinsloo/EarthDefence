...
class GameScene: SKScene {
    ...
    private func addEarthBackground() {
        ...
        // Add realistic continents - more visible green landmasses
        // Africa/Europe
        let africa = SKShapeNode(ellipseOf: CGSize(width: 70, height: 90))
        africa.position = CGPoint(x: 20, y: -10)
        africa.fillColor = SKColor(red: 0.2, green: 0.6, blue: 0.3, alpha: 0.9)  // Rich green
        africa.strokeColor = SKColor(red: 0.15, green: 0.5, blue: 0.25, alpha: 0.5)
        africa.lineWidth = 1
        africa.zRotation = 0.2
        earth.addChild(africa)
        
        // Americas
        let americas = SKShapeNode(ellipseOf: CGSize(width: 50, height: 100))
        americas.position = CGPoint(x: -70, y: 0)
        americas.fillColor = SKColor(red: 0.25, green: 0.65, blue: 0.35, alpha: 0.85)
        americas.strokeColor = SKColor(red: 0.2, green: 0.55, blue: 0.3, alpha: 0.4)
        americas.lineWidth = 1
        americas.zRotation = -0.3
        earth.addChild(americas)
        
        // Asia
        let asia = SKShapeNode(ellipseOf: CGSize(width: 85, height: 60))
        asia.position = CGPoint(x: 60, y: 50)
        asia.fillColor = SKColor(red: 0.22, green: 0.62, blue: 0.32, alpha: 0.87)
        asia.strokeColor = SKColor(red: 0.18, green: 0.52, blue: 0.28, alpha: 0.45)
        asia.lineWidth = 1
        asia.zRotation = 0.5
        earth.addChild(asia)
        
        // Australia
        let australia = SKShapeNode(ellipseOf: CGSize(width: 35, height: 25))
        australia.position = CGPoint(x: 70, y: -70)
        australia.fillColor = SKColor(red: 0.24, green: 0.58, blue: 0.34, alpha: 0.8)
